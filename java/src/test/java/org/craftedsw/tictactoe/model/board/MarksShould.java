...
public class MarksShould {
    ...
    inform_when_it_is_full() {
        Marks marks = marks()
                            ...
                            .fromPlayerTwoAt(CELL_6, CELL_7, CELL_8, CELL_9).build();
    ...
    inform_which_is_the_first_empty_cell() {
        Marks marks = marks()
                            .fromPlayerOneAt(CELL_1, CELL_2, CELL_7, CELL_9).build();
    ...
    return_the_first_empty_side_cell() {
        Marks marks = marks()
                            ...
                            .fromPlayerTwoAt(CELL_2, CELL_4).build();
    ...
    not_return_any_empty_side_cells_when_they_all_have_marks() {
        Marks marks = marks()
                            ...
                            .fromPlayerTwoAt(CELL_4, CELL_8).build();
    ...
    inform_the_number_of_marks_placed() {
        Marks marks = marks()
                            .fromPlayerOneAt(CELL_2, CELL_6)
                            .fromPlayerTwoAt(CELL_5, CELL_7).build();
