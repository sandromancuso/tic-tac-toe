...
public class MachinePlayerShould {
    ...
    @Mock private BlockStrategy blockStrategy;
    ...
    public void initialise() {
        ...
        when(strategiesIterator.next()).thenReturn(winStrategy, blockStrategy, cornerAttackStrategy);
    ...
    place_a_mark_returned_by_third_strategy_when_previous_two_strategies_returned_no_cell() {
        ...
        when(blockStrategy.nextCell(CROSS, marks)).thenReturn(NO_CELL);
